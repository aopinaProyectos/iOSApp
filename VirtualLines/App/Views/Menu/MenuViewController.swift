...
class MenuViewController: SwipeableTabBarController {
    ...
    func loadSection(section: menuSection) {
    ...
    func setupTabBar() {
        ...
        viewControllers![2].tabBarItem.image = self.resizeImage(image: UIImage(named: "StoreTB")!, targetSize: CGSize(width: 35, height: 35))
        viewControllers![2].tabBarItem.imageInsets = UIEdgeInsets.init(top: 5,left: 0,bottom: -5,right: 0)
        viewControllers![3].tabBarItem.image = self.resizeImage(image: UIImage(named: "Profile")!, targetSize: CGSize(width: 35, height: 35))
    ...
    func setupBar(){
        let imageOrigin = self.resizeImage(image: UIImage(named: "StoreTB")!, targetSize: CGSize(width: 45, height: 45))
...
protocol Routable {
    associatedtype T
    func loadController<T: UITabBarController>(navigation: T, section: menuSection)
}

extension MenuViewController: Routable {
